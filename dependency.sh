...
# install
# -------
yay -S wayland qt5-wayland qt6-wayland swayfx qutebrowser kitty wlogout waybar rofi-wayland yazi mpvpaper newsboat zoxide bat htop neovim fastfetch hyfetch exa fzf w3m httrack yt-dlp calcure bluetoothctl bluetui anvi podman gnudb 7zip zip xz clang lua rust go ffmpeg pandoc translate-git pycp battop pulsemixer ani-cli-git lobster-git starship thefuck less python impala navi dysk foot astroterm-bin mpv pass ollama virt-manager libreoffice ttf-firacode-nerd 
